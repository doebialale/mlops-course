...
### HELPER FUNCTIONS ###
wandb.init(project="credit-card-fraud-detection-test-515", name="data-cleaning")
...
def load_data():
    ...
    artifact = wandb.use_artifact('anicin/credit-card-fraud-detection-test-515/original_data:latest', type='dataset')

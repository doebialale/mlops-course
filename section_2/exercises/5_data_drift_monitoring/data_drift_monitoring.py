...
wandb.init(project="credit-card-fraud-detection-test-515", job_type="data-drift-monitoring") 
...
def load_data(): 
    ...
    ref_artifact = wandb.use_artifact('anicin/credit-card-fraud-detection-test-515/reference_data.csv:latest', type='dataset') 
    ...
    curr_artifact = wandb.use_artifact('anicin/credit-card-fraud-detection-test-515/original_data.csv:latest', type='dataset') 
